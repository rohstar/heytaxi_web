...
if ( ! function_exists('blogAjaxPagination'))
{
	function blogAjaxPagination() {
		...
		$attributes = array(
			...
			'show_date' => (isset($_POST['show_date']))?$_POST['show_date']:null,
			'show_author' => (isset($_POST['show_author']))?$_POST['show_author']:null,
			'show_categories' => (isset($_POST['show_categories']))?$_POST['show_categories']:null,
			'show_tags' => (isset($_POST['show_tags']))?$_POST['show_tags']:null,
			'show_comments' => (isset($_POST['show_comments']))?$_POST['show_comments']:null,
			'show_read_more' => (isset($_POST['show_read_more']))?$_POST['show_read_more']:null,
			'category' => (isset($_POST['category']))?$_POST['category']:null,
			'items' => (isset($_POST['items']))?$_POST['items']:null,
			'columns' => (isset($_POST['columns']))?$_POST['columns']:null,
		);

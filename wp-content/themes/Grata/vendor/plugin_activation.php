...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'   				=> get_template_directory() . '/vendor/plugins/revslider.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '4.6.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented

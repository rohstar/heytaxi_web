...
//	$of_page = add_theme_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
	$of_page = add_submenu_page( 'us-home', 'Grata: Theme Options', 'Theme Options', 'manage_options', 'us-optionsframework', 'optionsframework_options_page' );
...
function us_save_styles($new_smof_data = null){
	...
	{
		if ( ! wp_mkdir_p(trailingslashit($styles_dir))) {
			return false;
		}
